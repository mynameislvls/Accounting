...
public class CursorAdapter_out extends BaseAdapter{
	...
	public CursorAdapter_out(Context context,Cursor cursor) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Cursor cursor = db.query("outtable",
				new String[] { "barcode", "name","time","price","number" },null,null, null, null,
				null);
